...
export const storagelastname = "demo_user_lastname";
export const storageemail = "demo_user_email";
export const storagefirstname = "demo_user_firstname";
...
export const setLocalToken = (authData: IAuth): void => {
  ...
  localStorage.setItem(storageUsername, authData.user.username);
  localStorage.setItem(storagefirstname, authData.user.first_name);
  localStorage.setItem(storagelastname, authData.user.last_name);
  localStorage.setItem(storageemail, authData.user.email);
...
export const unsetLocalToken = (): void => {
  ...
  localStorage.removeItem(storagelastname);
